Pod::Spec.new do |s|
  ...
  s.version                 = '4.0.2.gambit'

  s.summary                 = 'Use Tesseract OCR in iOS projects written in either Objective-C or Swift.'

  s.homepage                = 'https://github.com/GambitITSolutions/Tesseract-OCR-iOS'
  s.documentation_url       = 'https://github.com/GambitITSolutions/Tesseract-OCR-iOS/blob/master/README.md'
  ...
  s.source                  = { :git => 'https://github.com/GambitITSolutions/Tesseract-OCR-iOS.git',                                                         :tag => s.version.to_s }
